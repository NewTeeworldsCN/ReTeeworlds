...
void CClient::SendInfo()
{
	...
	str_copy(m_aServerPassword, Config()->m_Password, sizeof(m_aServerPassword));
...
void CClient::RegisterCommands()
{
	...
	m_pConsole->Register("quit", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Quit, this, "Quit ReTeeworlds");
	m_pConsole->Register("exit", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Quit, this, "Quit ReTeeworlds");
	m_pConsole->Register("minimize", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Minimize, this, "Minimize ReTeeworlds");
...
#endif
{
	...
	IEngine *pEngine = CreateEngine("ReTeeworlds");
	IConsole *pConsole = CreateConsole(FlagMask);
	IStorage *pStorage = CreateStorage("ReTeeworlds", IStorage::STORAGETYPE_CLIENT, argc, argv);
